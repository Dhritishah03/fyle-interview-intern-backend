...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(assignment.state == AssignmentStateEnum.DRAFT, 'Assignment cannot be graded without Submission')
    ...
    def mark_grade_principal(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_valid(grade is not None, 'assignment with empty grade cannot be graded')
        assertions.assert_valid(assignment.state != AssignmentStateEnum.DRAFT, 'Assignment must be in Submitted or Graded state')
    ...
    def get_assignments_by_teacher(cls, teacher_id):
        ...
        cls.state.in_([AssignmentStateEnum.SUBMITTED, AssignmentStateEnum.GRADED])).all()
