...
#     # Define the expected result before any changes
#     expected_result = [(1, 3)]  # Replace this with your expected query result
    

#     # Execute the SQL query before committing the session
#     with open('tests/SQL/number_of_graded_assignments_for_each_student.sql', encoding='utf8') as fo:
#         sql = fo.read()
...
#     # Debugging: Check if the assignments are actually created
...
#     # Compare the result with the expected count
#     assert grade_a_count_1 == sql_result[0][0]
